...
public class SomeConstant {
	...
	public static final String SQL_SELECT_ALL_CAR = "SELECT cars.id, cars.mark, cars.car_number, car_condition.status_car FROM cars INNER JOIN car_condition ON cars.car_condition_id = car_condition.id LIMIT ?,?";
	...
	public static final String SQL_INSERT_CAR_WITH_DRIVERS = "INSERT INTO users_has_cars(users_id, cars_id) VALUES(?, (SELECT id FROM cars WHERE cars.mark = ?))";
	...
	public static final String SQL_GET_COUNT_ALL_CAR = "SELECT COUNT(*) AS COUNT FROM cars INNER JOIN car_condition ON cars.car_condition_id = car_condition.id";
